        ...
        <div className="grid w-full items-center gap-14 py-16 lg:grid-cols-2 lg:gap-20 lg:py-24">
          ...
          >
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-slate-300 sm:text-lg">
              Capacitación especializada, certificación por competencias
              y servicios profesionales en emergencias, atención
              prehospitalaria, bomberos y protección civil.
            </p>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 shadow-2xl">
              ...
              <div className="relative aspect-[4/5] overflow-hidden sm:aspect-[5/4] lg:aspect-[4/5]">
                ...
                {/* =====================================
                    ...
                    Cuando tengas la fotografía definitiva,
                    podremos sustituir este bloque por:

                    <img
                      src="/images/nombre-de-la-foto.jpg"
                      alt="MT Emergencias"
                ...
                <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-gradient-to-br from-[#13385d] via-[#0b2742] to-[#071b2f]">
                  ...
                  <div className="relative z-10 px-8 text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-xs text-sm leading-6 text-slate-400">
                      Aquí mostraremos fotografías reales de nuestras
                      capacitaciones, servicios y actividades.
                    </p>
                ...
                {/* Degradado */}
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#071b2f]/80 via-transparent to-transparent" />
