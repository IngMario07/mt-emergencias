...
import NosotrosImg from "../public/images/Nosotros.png";
          ...
          <div className="grid min-h-[65vh] items-center gap-12 py-20 lg:grid-cols-2 lg:py-28">
            ...
            <div>
              ...
              <p className="mt-7 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Somos una empresa enfocada en capacitación, certificación por
                competencias y servicios profesionales relacionados con
                emergencias, atención prehospitalaria, bomberos y protección
                civil.
              </p>
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[2rem] border border-white/10 bg-white shadow-2xl">
                <img
                  src={NosotrosImg}
                  alt="MT Emergencias"
        ...
        <div className="container-mt">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            ...
            <div className="space-y-5 text-base leading-8 text-slate-600 sm:text-lg">
              ...
              <p>
                Nuestro enfoque combina formación teórica y práctica con una
                visión orientada a la preparación y respuesta profesional.
              </p>

              <p>
                Buscamos que cada persona, empresa o institución encuentre una
                solución adecuada a sus necesidades de capacitación,
        ...
        <div className="container-mt">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 leading-7 text-slate-600">
              Desarrollamos soluciones relacionadas con formación, evaluación
              y respuesta profesional.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <article className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Servicios relacionados con atención prehospitalaria y
            ...
            <article className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Formación y servicios relacionados con prevención, preparación
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl leading-7 text-slate-300">
                Nuestro trabajo busca conectar el conocimiento con la práctica
                y la preparación con la capacidad de responder.
              </p>
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
              {/* Profesionalismo */}
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition duration-300 hover:-translate-y-1 hover:border-[#fbc94d]/30 hover:bg-white/[0.07]">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Buscamos mantener procesos claros y una atención profesional
                  en cada servicio.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition duration-300 hover:-translate-y-1 hover:border-[#fbc94d]/30 hover:bg-white/[0.07]">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Promovemos el desarrollo continuo de conocimientos y
                  habilidades.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition duration-300 hover:-translate-y-1 hover:border-[#fbc94d]/30 hover:bg-white/[0.07]">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  La evaluación permite reconocer las competencias conforme al
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition duration-300 hover:-translate-y-1 hover:border-[#fbc94d]/30 hover:bg-white/[0.07]">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Nuestro enfoque está orientado a la preparación para
                  situaciones reales.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:flex-row md:items-center">
              ...
              <div>
                ...
                <p className="mt-4 leading-7 text-slate-600">
                  En MT Emergencias queremos que conozcas la diferencia y
                  entiendas cómo funciona la certificación por competencias.
                </p>
